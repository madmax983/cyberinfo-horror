...
HIDDEN_FILES = {
    ...
    "orion": "\n[FILE RETRIEVED: LIGHTHOUSE_LOG]\nI am not guiding ships. I am warning them that the land is dead.",
    "dredge": "\n[FILE RETRIEVED: SEWER_LOG]\nWe don't mine for gold. We mine for passwords. They are worth more."
}
    ...
    while True:
        try:
            ...
            if user_input.startswith("encrypt "):
                ...
                type_print("TRY ASKING ABOUT: LENS, VANE, ROT, KAEL, MIRA, SYLA, KORA, NIX, EDITOR, REN, TESS, KADE, MIKO, SILAS, JACE, DAX, KIAN, VERO, ELARA, ORION, DREDGE.", 0.03)
            else:
